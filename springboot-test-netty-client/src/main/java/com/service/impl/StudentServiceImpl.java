...
public class StudentServiceImpl implements IStudentService
{
    ...
    public StudentServiceImpl(ApplicationContext context)
    {
        stuDao = context.getBean(IStudentDao.class);
        teacherDao = context.getBean(ITeacherDao.class);
        stuAndteacherDao = context.getBean(IStudentAndTeacherDao.class);
        idCardDao = context.getBean(IStudentIdCardDao.class);
    }
